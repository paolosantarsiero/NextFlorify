  ...
  return (
    <div className="w-3/4 h-full z-10 relative m-auto">
      <div className="w-full -top-[150px] absolute flex flex-wrap justify-between">
        <button className="z-20 border p-2" onClick={prevAnimation}>Back</button>
        <button className="z-20 border p-2" onClick={nextAnimation}>Next</button>
        <button className="z-20 border p-2" onClick={flowerFlow}>Flower</button>
        <button className="z-20 border p-2" onClick={() => flowerSize(1)}>Fl M</button>
        <button className="z-20 border p-2" onClick={() => flowerSize(2)}>Fl L</button>
        <button className="z-20 border p-2" onClick={waitingAction}>Waiting</button>
        <button className="z-20 border p-2" onClick={sweetAction}>Sweet</button>
        <button className="z-20 border p-2" onClick={() => switchAnimation("MAINpnpm")}>Switch</button>
      </div>
